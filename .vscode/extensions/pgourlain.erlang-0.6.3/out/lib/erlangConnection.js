...
exports.ErlangConnection = exports.setExtensionPath = exports.erlangBridgePath = void 0;
...
exports.erlangBridgePath = path.join(__dirname, "..", "..", rebar3BuildPath);
/**
...
function setExtensionPath(currentExtensionPath) {
    exports.erlangBridgePath = path.join(currentExtensionPath, rebar3BuildPath);
}
...
class ErlangConnection extends events_1.EventEmitter {
    ...
    compile_erlang_connection() {
        return new Promise((a, r) => {
            ...
            const ebinDir = path.join(exports.erlangBridgePath, '..', 'ebin');
            if (!fs.existsSync(ebinDir)) {
                fs.mkdirSync(ebinDir);
            }
            let args = ["-o", path.normalize(ebinDir)].concat(erlFiles);
            return compiler.Compile(path.join(exports.erlangBridgePath, 'src'), args).then(res => {
