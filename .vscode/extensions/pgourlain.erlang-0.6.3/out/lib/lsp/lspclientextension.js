...
exports.deactivate = exports.debugLog = exports.activate = exports.client = void 0;
const os = require("os");
...
function compileErlangBridge(extensionPath) {
    return new RebarShell_1.default([], extensionPath, vscodeAdapter_1.ErlangOutputAdapter())
...
function activate(context) {
    ...
    exports.client = new vscode_languageclient_1.LanguageClient(clientName, () => __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            yield compileErlangBridge(context.extensionPath);
            let erlangLsp = new ErlangShellLSP_1.ErlangShellLSP(vscodeAdapter_1.ErlangOutputAdapter(lspOutputChannel));
